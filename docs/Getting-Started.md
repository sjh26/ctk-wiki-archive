...
1. CTK mailing list
For asking questions, please use the mailing list:

 ctk-developers@commontk.org

The signup form and historical data for the mailing list is:

 http://public.kitware.com/mailman/listinfo/ctk-developers

The mailing list archives are available here:

  http://public.kitware.com/pipermail/ctk-developers/