...
1. Design
(based on [Documentation/Architecture](Documentation/Architecture)(Documentation/Architecture.md) and workshop results)
...
One goal will be to use a common scene representation (see [wiki:ctkScene](wiki:ctkScene)).
