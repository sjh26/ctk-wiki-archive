...
1. Overview
Testing of both CTK widgets and application built on top of CTK could leverage the capabilities offered by the [QtTesting library](http://www.paraview.org/Wiki/Testing_design) developed by [Paraview](http://www.paraview.org) folks.
...
#* Including the class :
#***ctkEventTranslaterPlayerWidget* : Widget used by the Unit Test - [Image](http://www.commontk.org/index.php/File:CtkEventTranslatorPlayerWidget.png)
...
1. All the CTK Widgets are not yet tested - Below the [summary table](http://www.commontk.org/index.php/Documentation/Widget_testing#Player.2FTranslators_Widget_Testing) -
...
Here the link to my Github for the [QSpinBox](https://github.com/benjaminlong/QtTesting/tree/88-IssueQSpinBox)br/
Here the link to my Github for the [QDoublSpinBox](https://github.com/benjaminlong/QtTesting/tree/88-IssueQDoubleSpinBox)
...
1. Add unit test to all the widget - Below, the [summuray table](http://www.commontk.org/index.php/Documentation/Widget_testing#Player.2FTranslators_Widget_Testing) -
...
1. Create an Application test - [ctkQtTesting](http://www.commontk.org/index.php/File:CtkQtTestingScreenShot.png) - `{{Done}}`
