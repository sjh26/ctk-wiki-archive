...
If you want to know more about how to set-up your CMake build system to integrate CTK, have a look at [ Setting up a project using the CTK Plugin Framework].

    1. Example Code
Below is a minimal code sample demonstrating how to use the CTK Plugin Framework to get a specific service (we will use the [ctkEventAdmin](http://www.commontk.org/docs/html/structctkEventAdmin.html) service in this example):

[UseCTKPluginMain.cpp](https://github.com/saschazelzer/CTKPluginTutorials/blob/master/Apps/UseCTKPlugin/UseCTKPluginMain.cpp)
