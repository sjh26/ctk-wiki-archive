...
The CTK Plugin Framework can shortly be described as a dynamic component system for C++.
  ...
  1. Design
The design of the CTK Plugin Framework (see also the [Design Document](../Documentation/PluginFramework-DesignDoc.html)) is heavily inspired by [OSGi](http://www.osgi.org) (a dynamic component system for Java) and enables
...
![Figure 1: Layered Model of the CTK Plugin Framework](../images/PluginFWLayering.png)
...
A more detailed explanation of these concepts can be found below.
  ...
  1. Plugins
A CTK Plugin is, at it's core, a shared library based on the [Qt Plugin](http://doc.qt.nokia.com/latest/plugins-howto.html) system.
...
![Figure 2: Registering and getting a service](../images/CTKService.png)
...
additional complexity at first, but using helper classes like [ctkServiceTracker](http://www.commontk.org/docs/html/classctkServiceTracker.html) and a
...
designed closely to the service specifications published in the [OSGi Service Platform Release 4 Compendium Specification](http://www.osgi.org/Specifications/HomePage).
...
is taken from [Benefits of Using OSGi](http://www.osgi.org/About/WhyOSGi) and adapted to the CTK context.
