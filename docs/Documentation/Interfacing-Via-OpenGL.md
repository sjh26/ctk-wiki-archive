...
*This is a development idea for discussion and experimentation at the [May, 2010 Hackfest](../CTK-Hackfest-May-2010.html)*

  1. Possible vtkXIPActor (or vtkOpenInventorActor)
    1. Proof of Concept
- A link between vtk and xip could be done by following the example of the [vtkOpenGLScriptedActor](http://www.slicer.org/slicerWiki/index.php/Slicer3:Python:ScriptedActor).  In this example:
