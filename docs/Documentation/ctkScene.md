...
![Figure 1. a possible design pattern for ctk](../images/Ctk_view_encapsualtion.gif)
...
![Figure 2. An illustration of how the model-view-controller design pattern can be applied to a ctkScene.](../images/CtkMVCDesignPattern.png)

![Figure 3. Revision to Figure 1 based on the MVC design shown in Figure 2. Actors are removed from being part of the scene.](../images/Ctk_view_encapsualtion-Revsized.gif)
