...
#:: If you built CTK with the VTK option, then you also need to add in your **LD_LIBRARY_PATH** (or **PATH** on Windows) environment variable the path to the VTK libraries (e.g. VTKCommon.dll). Those files are typically located in *.../CTK-build/VTK-build/bin[/Release](/Release)*.
